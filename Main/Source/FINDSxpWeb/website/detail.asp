								...
								<td colspan=0>
									<table>
										<tr>
											...
											<td bgcolor=#b0b0b0 width=140><center><font face="arial, helvetica, Tahoma"><b>Navigation</b></font></center>
											</td>
											<td bgcolor=#b0b0b0 width=300><center><font face="arial, helvetica, Tahoma"><b>Reports</b></font></center>
											</td>
											<td bgcolor=#b0b0b0 width=180><center><font face="arial, helvetica, Tahoma"><b>Scanned Documents</b></font></center>
											</td>
										</tr>
										<tr>
											<td width=50>&nbsp;
															...
															%>
																...
																<tr>
																	<td valign=Center>
																			...
																			<a href='JavaScript: document.docselection.submit()'><FONT face="Tahoma, Arial, Helvetica, sans-serif" size=2 color=blue><center><b>GENERATE REPORT</b></center></font></a>
																		</form>
																	</td>
																</tr>
															<%
											...
											<! *** SCANNED IMAGE RETREIVAL *** !>
											<td valign=top align=center>
											<form method="POST" name="pacerrfpostsearch" action="http://rfieclient.pacer.com:9081/rf/CMBControlServlet">
												<input type="hidden" name="action" value="search"><!--search action-->
												<input type="hidden" name="ic" value="RFIDOC">
												<input type="hidden" name="kf.File Number" value=<%=request("tracknum")%>>
												<%
												'For each fwpUserScanDoc, store scanned document type
												Set objConn = Server.CreateObject("ADODB.Connection")
												Set rs = Server.CreateObject("ADODB.RecordSet")
												objConn.Open Application("DB_CONNECT_STRING")

												'Get the Documents available to the user
												rs.Open "fwpUserScanDocSelect '" & session("UserRole") & "'", objConn

												'Only display scanned document information if available
												If not rs.EOF Then
													...
													do while Not rs.EOF
														strTemp = strTemp & rs("DocName")
														rs.MoveNext
													Loop
												%>
													<input type="hidden" name="kf.Document Type" value="<%=Server.HTMLEncode(strTemp)%>">
													<!-- *** Search *** -->
													<TABLE border=0 cellspacing=0 cellpadding=0 width="40">
														...
														<tr>
														<td align=center><input TYPE="submit" NAME="submit" VALUE="Find Documents"></td>
														</tr>
													</TABLE>
													<!-- *** End Search Table *** -->
												<% 
												...
												%>
													<TABLE border=0 cellspacing=0 cellpadding=0 >
														...
														<tr>&nbsp;
													        ...
													        <tr>
														<% Response.Write("No Documents Available") %>
														</tr>
													</TABLE>
												<%
												End If
