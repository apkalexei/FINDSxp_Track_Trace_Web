...
<HTML>
<HEAD>
	<TITLE>RF International - Transaction Type Selection Screen </TITLE>
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%" border=0>
	<TR vAlign=center align=middle>
		<TD align=center>
			<TABLE cellSpacing=0 cellPadding=0 border=0>
				<tr>
					<TD width=vAlign=top align=center colSpan=2 rowSpan=2>
						<b><font size=7>T</font><font size=6>RANSACTION</font><font size=7>&nbsp;T</font><font size=6>YPE</font><font size=7>&nbsp;S</font><font size=6>ELECTION</font></b></td>
					</td>
				</tr>
				<tr>
				</tr>
			...
			<% end if %>
					<TD valign=top height=160 colspan=2>
						<TABLE cellSpacing=2 cellPadding=2 border=0 name="form">
							<%
							' Show the links for each Transaction type, based on user role
							' ************************** TBA ******************************
							If blnShowBooking Then Response.Write("<TR><TD><a href='review.asp?MnTransType=0'><FONT face='Tahoma, Arial, Helvetica, sans-serif' size=3 color=blue><b>&nbsp;BOOKING SEARCH</b></font></a></TD></TR>")
							If blnShowBOL Then Response.Write("<TR><TD><a href='review.asp?MnTransType=1'><FONT face='Tahoma, Arial, Helvetica, sans-serif' size=3 color=blue><b>&nbsp;BILL OF LADING SEARCH</b></font></a></TD></TR>")
							If blnShowRates Then Response.Write("<TR><TD><a href='review.asp?MnTransType=2'><FONT face='Tahoma, Arial, Helvetica, sans-serif' size=3 color=blue><b>&nbsp;RATE SEARCH</b></font></a></TD></TR>")
							rs.Close
							objConn.Close()
							Set rs = Nothing
							Set objConn = Nothing
